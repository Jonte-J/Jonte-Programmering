...
int main()
{
    int mousex=0;
    int mousey=0;
    sf::RenderWindow window(sf::VideoMode(1024, 768), "Stats");
    tgui::Gui gui{window};
    ...
    //editBox ->setPosition(500, 500);
    

    gui.add(button);
    gui.add(editBox, "widget");
    editBox->setPosition(50, 50);
    sf::Vector2f position = editBox->getPosition();
    editBox->setSize(200, 50);
    sf::Vector2f size = editBox->getSize();
    //sparatext = editBox->getText();
